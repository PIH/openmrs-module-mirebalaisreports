...
@Component
public class MexicoCesMedsReportManager extends BasePihReportManager {
    ...
    public String getName() {
        return "mexicoCesMeds";
    }

    @Override
    public String getUuid() {
        return MirebalaisReportsProperties.MEXICO_CES_MEDS_REPORT_DEFINITION_UUID;
    }
