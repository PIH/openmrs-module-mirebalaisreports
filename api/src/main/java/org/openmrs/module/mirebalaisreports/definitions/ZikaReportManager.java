...
@Component
public class ZikaReportManager extends BasePihReportManager {
    ...
    @Override
    public String getComponent() { return Components.ZIKA; }
    ...
    public String getUuid() {
        return MirebalaisReportsProperties.ZIKA_REPORT_DEFINITION_UUID;
    }
