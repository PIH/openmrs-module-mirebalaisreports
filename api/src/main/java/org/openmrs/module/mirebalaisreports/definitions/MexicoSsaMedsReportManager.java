...
@Component
public class MexicoSsaMedsReportManager extends BasePihReportManager {
    ...
    public String getName() {
        return "mexicoSsaMeds";
    }

    @Override
    public String getUuid() {
        return MirebalaisReportsProperties.MEXICO_SSA_MEDS_REPORT_DEFINITION_UUID;
    }
