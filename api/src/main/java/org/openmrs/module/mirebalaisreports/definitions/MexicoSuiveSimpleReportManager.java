...
@Component
public class MexicoSuiveSimpleReportManager extends BasePihReportManager {
    ...
    public String getName() {
        return "mexicoSuiveSimple";
    }

    @Override
    public String getUuid() {
        return MirebalaisReportsProperties.MEXICO_SUIVE_SIMPLE_REPORT_DEFINITION_UUID;
    }
