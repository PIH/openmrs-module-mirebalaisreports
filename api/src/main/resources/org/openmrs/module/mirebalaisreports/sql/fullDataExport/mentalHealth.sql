...
-- TODO figure out how to break out suicidal thoughts and security plan
  (select o.encounter_id,
     ...
     max(CASE when crs.name = 'PIH' and crt.code = 'Days with difficulties in past month' then o.value_numeric end) 'Days-Difficult' ),
     max(CASE when crs.name = 'PIH' and crt.code = 'Days without usual activity in past month' then o.value_numeric end) 'Days-wo-activity' ),
     max(CASE when crs.name = 'PIH' and crt.code = 'Days with less activity in past month' then o.value_numeric end) 'Days-reduced' ),
