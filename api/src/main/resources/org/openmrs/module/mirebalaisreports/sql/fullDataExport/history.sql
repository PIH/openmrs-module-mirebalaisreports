...
SELECT encounter_type_id INTO @AdultInitEnc FROM encounter_type WHERE name = "Primary Care Adult Initial Consult";
SELECT encounter_type_id INTO @AdultFollowEnc FROM encounter_type WHERE name = "Primary Care Adult Followup Consult";
SELECT encounter_type_id INTO @PedInitEnc FROM encounter_type WHERE name = "Primary Care Pediatric Initial Consult";
SELECT encounter_type_id INTO @PedFollowEnc FROM encounter_type WHERE name = "Primary Care Pediatric Followup Consult";
