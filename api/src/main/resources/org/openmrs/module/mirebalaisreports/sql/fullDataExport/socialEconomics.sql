...
set @educationAnswers = concept_name(@education, 'fr');
set @people_living_in_house = concept_from_mapping('CIEL','1474');
set @number_of_children_living = concept_from_mapping('CIEL','1825');
set @number_of_rooms = concept_from_mapping('CIEL','1475');
set @radio = concept_from_mapping('PIH','1318');
set @television = concept_from_mapping('CIEL','159746');
set @fridge = concept_from_mapping('CIEL','159745');
set @bank_account = concept_from_mapping('PIH','11936');
set @toilet = concept_from_mapping('CIEL','159389');
set @latrine = concept_from_mapping('PIH','Latrine');
set @floor = concept_from_mapping('CIEL','159387');
set @roof = concept_from_mapping('CIEL','1290');
set @walls = concept_from_mapping('PIH','1668');
set @transport_method_to_clinic = concept_from_mapping('PIH','975');
set @cost_of_transport = concept_from_mapping('CIEL','159470');
set @travel_time_to_clinic = concept_from_mapping('PIH','CLINIC TRAVEL TIME');
set @main_daily_activities_before_illness = concept_from_mapping('PIH','1402');
set @ability_to_perform_main_daily_activity_since_illness = concept_from_mapping('PIH','11543');
set @recieved_assistance = concept_from_mapping('PIH','SOCIO-ECONOMIC ASSISTANCE ALREADY RECEIVED');
set @recommended_assistance = concept_from_mapping('PIH','SOCIO-ECONOMIC ASSISTANCE RECOMMENDED');
set @other_recommended_or_recieved_assistance_name = concept_from_mapping('PIH','SOCIO-ECONOMIC ASSISTANCE NON-CODED');
set @other = concept_from_mapping('PIH','OTHER');
set @socio_economic_assistance_comment = concept_from_mapping('PIH', 'SOCIO-ECONOMIC ASSISTANCE COMMENT');
set @undernourishment = concept_from_mapping('CIEL', '165491');
set @infant_mortality = concept_from_mapping('CIEL', '165492');
set @completed_six_years_schooling = concept_from_mapping('CIEL', '165493');
set @not_attending_school = concept_from_mapping('CIEL', '165494');
set @cooks_with_dung_wood_charcoal_or_coal = concept_from_mapping('CIEL', '165495');
set @household_sanitation_improvement = concept_from_mapping('CIEL', '165496');
set @improved_drinking_water = concept_from_mapping('CIEL', '165497');
set @electricity = concept_from_mapping('CIEL', '165498');
set @inadequate_housing_materials = concept_from_mapping('CIEL', '165499');
set @household_doesnot_own_assetts = concept_from_mapping('CIEL', '165500');
...
update temp_social_econ tsn
set education = concept_name(education_answer_concept, 'fr');
...
set tsn.travel_time_to_clinic = concept_name(o2.value_coded, 'fr');
