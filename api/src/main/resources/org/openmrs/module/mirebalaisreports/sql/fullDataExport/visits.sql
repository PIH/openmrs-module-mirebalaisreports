...
IF(first_visit.date_started = v.date_started, TRUE, FALSE) first_visit, IF(prv.date_started IS NOT NULL, TRUE, FALSE) 2nd_day, v.visit_id, pr.birthdate, pr.birthdate_estimated, ahe_section.user_generated_id as section_communale_CDC_ID
FROM patient p
