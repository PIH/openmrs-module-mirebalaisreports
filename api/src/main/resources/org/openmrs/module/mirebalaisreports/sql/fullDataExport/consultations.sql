...
e.visit_id, pr.birthdate, pr.birthdate_estimated, boarding_for_l.name as boarding_for, adt.encounter_id as dispo_encounter_id, addr_section.user_generated_id as 'Section Communale CDC ID'
