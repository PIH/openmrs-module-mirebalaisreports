...
e.visit_id, pr.birthdate, pr.birthdate_estimated, boarding_for_l.name as boarding_for, adt.encounter_id as dispo_encounter_id, ahe_section.user_generated_id as section_communale_CDC_ID,cn_pro.name as "procedure"
