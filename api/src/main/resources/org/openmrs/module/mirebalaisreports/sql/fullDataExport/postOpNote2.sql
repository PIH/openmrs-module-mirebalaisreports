...
IF(whole_blood.obs_id IS NOT NULL, 'Yes', 'No') whole_blood,
whole_blood_qty.value_numeric whole_blood_qty,
IF(plasma.obs_id IS NOT NULL, 'Yes', 'No') plasma,
plasma_qty.value_numeric plasma_qty,
IF(platelets.obs_id IS NOT NULL, 'Yes', 'No') platelets,
platelets_qty.value_numeric platelets_qty,
IF(packed_cells.obs_id IS NOT NULL, 'Yes', 'No') packed_cells,
...
INNER JOIN encounter e ON p.patient_id = e.patient_id and e.voided = 0 AND e.encounter_type = 4
...
LEFT OUTER JOIN concept_name emergency_n ON emergency.value_coded = emergency_n.concept_id AND emergency_n.locale = 'en' AND emergency_n.concept_name_type = 'FULLY_SPECIFIED' AND emergency_n.voided = 0
...
LEFT OUTER JOIN concept_name scheduled_n ON scheduled.value_coded = scheduled_n.concept_id AND scheduled_n.locale = 'en' AND scheduled_n.concept_name_type = 'FULLY_SPECIFIED' AND scheduled_n.voided = 0

--Planned
LEFT OUTER JOIN obs planned ON e.encounter_id = planned.encounter_id AND planned.concept_id = 440 AND planned.voided = 0
LEFT OUTER JOIN concept_name planned_n ON planned.value_coded = planned_n.concept_id AND planned_n.locale = 'en' AND planned_n.concept_name_type = 'FULLY_SPECIFIED' AND planned_n.voided = 0

--Wound
LEFT OUTER JOIN obs wound ON e.encounter_id = wound.encounter_id AND wound.concept_id = 522 AND wound.voided = 0
LEFT OUTER JOIN concept_name wound_n ON wound.value_coded = wound_n.concept_id AND wound_n.locale = 'en' AND wound_n.concept_name_type = 'FULLY_SPECIFIED' AND wound_n.voided = 0

--Fluids
LEFT OUTER JOIN obs fluids ON e.encounter_id = fluids.encounter_id AND fluids.concept_id = 496 AND fluids.voided = 0
LEFT OUTER JOIN concept_name fluids_n ON fluids.value_coded = fluids_n.concept_id AND fluids_n.locale = 'en' AND fluids_n.concept_name_type = 'FULLY_SPECIFIED' AND fluids_n.voided = 0
...
LEFT OUTER JOIN concept_name transfusion_n ON transfusion.value_coded = transfusion_n.concept_id AND transfusion_n.locale = 'en' AND transfusion_n.concept_name_type = 'FULLY_SPECIFIED' AND transfusion_n.voided = 0
...
LEFT OUTER JOIN concept_name antibiotics_n ON antibiotics.value_coded = antibiotics_n.concept_id AND antibiotics_n.locale = 'en' AND antibiotics_n.concept_name_type = 'FULLY_SPECIFIED' AND antibiotics_n.voided = 0
...
LEFT OUTER JOIN concept_name antibiotics_type_n ON antibiotics_type.value_coded = antibiotics_type_n.concept_id AND antibiotics_type_n.locale = 'en' AND antibiotics_type_n.concept_name_type = 'FULLY_SPECIFIED' AND antibiotics_type_n.voided = 0
...
LEFT OUTER JOIN concept_name venous_proph_n ON venous_proph.value_coded = venous_proph_n.concept_id AND venous_proph_n.locale = 'en' AND venous_proph_n.concept_name_type = 'FULLY_SPECIFIED' AND venous_proph_n.voided = 0
...
LEFT OUTER JOIN concept_name pathology_n ON pathology.value_coded = pathology_n.concept_id AND pathology_n.locale = 'en' AND pathology_n.concept_name_type = 'FULLY_SPECIFIED' AND pathology_n.voided = 0
...
LEFT OUTER JOIN concept_name lab_n ON lab.value_coded = lab_n.concept_id AND lab_n.locale = 'en' AND lab_n.concept_name_type = 'FULLY_SPECIFIED' AND lab_n.voided = 0
...
LEFT OUTER JOIN concept_name implant_n ON implant.value_coded = implant_n.concept_id AND implant_n.locale = 'en' AND implant_n.concept_name_type = 'FULLY_SPECIFIED' AND implant_n.voided = 0
...
LEFT OUTER JOIN concept_name complication_n ON complication.value_coded = complication_n.concept_id AND complication_n.locale = 'en' AND complication_n.concept_name_type = 'FULLY_SPECIFIED' AND complication_n.voided = 0
