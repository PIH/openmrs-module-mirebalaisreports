...
public abstract class BaseInpatientReportTest extends BaseMirebalaisReportTest {
    ...
    public void setupDontOverrideBaseClassSetup() throws Exception {
        ...
        EncounterType transfer = emrApiProperties.getTransferWithinHospitalEncounterType();
        EncounterType exit = emrApiProperties.getExitFromInpatientEncounterType();
        EncounterType consultation = emrApiProperties.getConsultEncounterType();
        EncounterType postOpNote = mirebalaisReportsProperties.getPostOpNoteEncounterType();
        Location mirebalaisHospital = mirebalaisReportsProperties.getMirebalaisHospitalLocation();
        Location outpatientClinic = mirebalaisReportsProperties.getOutpatientLocation();
        ...
        Location emergencyDepartment = mirebalaisReportsProperties.getEmergencyLocation();
